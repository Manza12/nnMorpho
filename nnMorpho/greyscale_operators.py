...
def erosion(input_tensor: torch.Tensor,
    ...
    # Compute erosion
    result = greyscale_operators_cpp.erosion(input_tensor, structuring_element, footprint, origin[0], origin[1], border[0])
...
def dilation(input_tensor: torch.Tensor,
    ...
    # Compute erosion
    result = greyscale_operators_cpp.dilation(input_tensor, structuring_element, footprint, origin[0], origin[1])
