...
// Forward kernel
// -----------------------------------
__global__ void dilation2d_forward_kernel(
...
// Backward kernel
// -----------------------------------
__global__ void dilation2d_backward_kernel(
...
std::vector<torch::Tensor> dilation2d_forward_cuda(
    ...
    dilation2d_forward_kernel<<<blocks, threads>>>(
...
std::vector<torch::Tensor> dilation2d_backward_cuda(
    ...
    dilation2d_backward_kernel<<<blocks, threads>>>(
